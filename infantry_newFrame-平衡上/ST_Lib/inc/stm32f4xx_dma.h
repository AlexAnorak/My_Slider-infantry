...
/** @defgroup DMA_channel DMA_channel
  * @{
  */ 
...
/** @defgroup DMA_fifo_direct_mode DMA_fifo_direct_mode
  * @{
  */ 
...
/** @defgroup DMA_fifo_threshold_level DMA_fifo_threshold_level
  * @{
  */ 
...
/** @defgroup DMA_memory_burst DMA_memory_burst
  * @{
  */ 
...
/** @defgroup DMA_peripheral_burst DMA_peripheral_burst
  * @{
  */ 
...
/** @defgroup DMA_fifo_status_level DMA_fifo_status_level
  * @{
  */
...
/** @defgroup DMA_interrupts_definitions DMA_interrupts_definitions
  * @{
  */ 
...
/** @defgroup DMA_peripheral_increment_offset DMA_peripheral_increment_offset
  * @{
  */ 
...
/** @defgroup DMA_flow_controller_definitions DMA_flow_controller_definitions
  * @{
  */ 
...
/** @defgroup DMA_memory_targets_definitions DMA_memory_targets_definitions
  * @{
  */ 
