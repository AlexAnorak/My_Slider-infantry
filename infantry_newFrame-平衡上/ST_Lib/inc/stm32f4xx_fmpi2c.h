...
/** @defgroup FMPI2C_Exported_Constants FMPI2C_Exported_Constants
  * @{
  */

#define IS_FMPI2C_ALL_PERIPH(PERIPH)       ((PERIPH) == FMPI2C1) 

/** @defgroup FMPI2C_Analog_Filter FMPI2C_Analog_Filter
  * @{
  */
...
/** @defgroup FMPI2C_Digital_Filter FMPI2C_Digital_Filter
  * @{
  */
...
/** @defgroup FMPI2C_mode FMPI2C_mode
  * @{
  */
...
/** @defgroup FMPI2C_acknowledgement FMPI2C_acknowledgement
  * @{
  */
...
/** @defgroup FMPI2C_acknowledged_address FMPI2C_acknowledged_address
  * @{
  */
...
/** @defgroup FMPI2C_own_address1 FMPI2C_own_address1
  * @{
  */
...
/** @defgroup FMPI2C_transfer_direction FMPI2C_transfer_direction
  * @{
  */
...
/** @defgroup FMPI2C_DMA_transfer_requests FMPI2C_DMA_transfer_requests
  * @{
  */
...
/** @defgroup FMPI2C_slave_address FMPI2C_slave_address
  * @{
  */
...
/** @defgroup FMPI2C_own_address2 FMPI2C_own_address2
  * @{
  */
...
/** @defgroup FMPI2C_own_address2_mask FMPI2C_own_address2_mask
  * @{
  */
...
/** @defgroup FMPI2C_timeout FMPI2C_timeout
  * @{
  */
...
/** @defgroup FMPI2C_registers FMPI2C_registers
  * @{
  */
...
/** @defgroup FMPI2C_interrupts_definition FMPI2C_interrupts_definition
  * @{
  */
...
/** @defgroup FMPI2C_flags_definition FMPI2C_flags_definition
  * @{
  */
...
/** @defgroup FMPI2C_ReloadEndMode_definition FMPI2C_ReloadEndMode_definition
  * @{
  */
...
/** @defgroup FMPI2C_StartStopMode_definition FMPI2C_StartStopMode_definition
  * @{
  */
