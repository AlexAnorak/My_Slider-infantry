...
/** @defgroup FLASH_Voltage_Range FLASH_Voltage_Range
  * @{
  */ 
...
/** @defgroup FLASH_Sectors FLASH_Sectors
  * @{
  */
...
/** @defgroup Option_Bytes_Write_Protection Option_Bytes_Write_Protection
  * @{
  */ 
...
/** @defgroup Selection_Protection_Mode Selection_Protection_Mode
  * @{
  */
...
/** @defgroup Option_Bytes_PC_ReadWrite_Protection Option_Bytes_PC_ReadWrite_Protection
  * @{
  */ 
...
/** @defgroup FLASH_BOR_Reset_Level FLASH_BOR_Reset_Level
  * @{
  */  
...
/** @defgroup FLASH_Dual_Boot FLASH_Dual_Boot
  * @{
  */
...
/** @defgroup FLASH_Program_Parallelism FLASH_Program_Parallelism
  * @{
  */
