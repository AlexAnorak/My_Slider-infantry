/*
 * @Author:SHERLOCK
 * @Date: 2021-04-11 21:21:54
 * @LastEditTime: 2021-04-22 15:41:42
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \Projectd:\TDT\TDT-Frame\TDT_Alg\src\SteeringWheel.cpp
 */
...
bool SteeringWheel::judgeWheelPrepared(vec4f angleFeedback)
{
	...
	float maxError = Math_Max(ABS(wheelAngleError.data[0]), ABS(wheelAngleError.data[1]), ABS(wheelAngleError.data[2]), ABS(wheelAngleError.data[3]), 0, 0);
	if (maxError > 14.0f)
	{
		return false;
	}
...
bool SteeringWheel::turningBack(void)
{
	return 1;
}