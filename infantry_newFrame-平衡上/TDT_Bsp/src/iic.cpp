...
/**
 * @ingroup TDT_BSP
 * @defgroup TDT_BSP_IIC IIC
 * @brief 提供了包括软件IIC和硬件IIC配置、发送和接受
 */
...
/**
  ...
  * @param[in] SlaveAddress 未左移一位的从机地址
  */
