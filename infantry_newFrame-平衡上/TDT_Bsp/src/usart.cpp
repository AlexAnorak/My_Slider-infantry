...
void Communicate_Update(void)  
{
	...
	record_Send_Struct.yawSetValue = gimbal.gimbalPositionSet[0];
	record_Send_Struct.yawFbValue = gimbal.gimbalPositionFb[0];
	record_Send_Struct.pitchSetValue = gimbal.gimbalPositionSet[1];
	record_Send_Struct.pitchFbValue = gimbal.gimbalPositionFb[1];
	record_Send_Struct.gimbalMode = gimbal.gimbalMode;
