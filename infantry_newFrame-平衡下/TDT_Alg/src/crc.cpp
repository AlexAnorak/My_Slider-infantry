...
/**
 * @details CRC8 Verify function 
 * @param[in] pchMessage Data to Verify
 * @param[in] dwLength Stream length = Data + checksum 
 * @param[in] ucCRC8 last crc8 output; if is first, it should be 0xff
 * @retval new crc8 output
*/
unsigned char Get_CRC8_Check_Sum(unsigned char *pchMessage,unsigned  int dwLength,unsigned char ucCRC8) 
{ 
...
/**
 * @details append CRC8 to the end of data 
 * @param[in] pchMessage Data to CRC and append
 * @param[in] dwLength Stream length = Data + checksum 
*/
void Append_CRC8_Check_Sum(unsigned char *pchMessage, unsigned int dwLength) 
{ 
...
/**
 * @details CRC16 Verify function 
 * @param[in] pchMessage Data to Verify
 * @param[in] dwLength Stream length = Data + checksum 
 * @param[in] wCRC last crc16 output; if is first, it should be 0xffff
 * @retval new crc16 output
*/
uint16_t Get_CRC16_Check_Sum(uint8_t *pchMessage,uint32_t dwLength,uint16_t wCRC) 
{ 
	uint8_t chData; 
...
/**
 * @details append CRC16 to the end of data 
 * @param[in] pchMessage Data to CRC and append
 * @param[in] dwLength Stream length = Data + checksum 
*/
void Append_CRC16_Check_Sum(uint8_t * pchMessage,uint32_t dwLength) 
