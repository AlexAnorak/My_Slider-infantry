...
const u8 F6x8[] =
{
    ...
    0x00, 0x44, 0x64, 0x54, 0x4C, 0x44 ,   // z 0x7a
...
//rst pa4
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;//PB5~7复用功能输出	
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//复用功能
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
...
//rst pa4
	//dc pa6
	//cs pb0
//#define OLED_PORT_SPI   GPIOA
//#define OLED_PORT_NORMAL GPIOC
...
//#define OLED_RST(X)  X?GPIO_SetBits(GPIOA, GPIO_Pin_4):GPIO_ResetBits(GPIOA, GPIO_Pin_4)      

//#define OLED_DC(X)   X?GPIO_SetBits(GPIOA, GPIO_Pin_6):GPIO_ResetBits(GPIOA, GPIO_Pin_6)  
u8 resetCnt=0;
void LCD_Init(u8 ID)        
{
 //DDRA=0XFF;
