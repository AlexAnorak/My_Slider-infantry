...
/** @defgroup PWR_Regulator_state_in_STOP_mode PWR_Regulator_state_in_STOP_mode
  * @{
  */
...
/** @defgroup PWR_Regulator_state_in_UnderDrive_mode PWR_Regulator_state_in_UnderDrive_mode
  * @{
  */
...
/** @defgroup PWR_Wake_Up_Pin PWR_Wake_Up_Pin
  * @{
  */
