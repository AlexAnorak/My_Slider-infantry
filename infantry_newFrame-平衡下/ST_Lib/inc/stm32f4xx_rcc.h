...
/** @defgroup RCC_LSE_Dual_Mode_Selection RCC_LSE_Dual_Mode_Selection
  * @{
  */
...
/** @defgroup RCC_PLLSAIDivR_Factor RCC_PLLSAIDivR_Factor
  * @{
  */
...
/** @defgroup RCC_APB1_APB2_Clock_Source RCC_APB1_APB2_Clock_Source
  * @{
  */
...
#if defined(STM32F412xG) || defined(STM32F413_423xx) || defined(STM32F446xx)
/** @defgroup RCC_I2S_Clock_Source RCC_I2S_Clock_Source
  * @{
  */
...
/** @defgroup RCC_I2S_APBBus RCC_I2S_APBBus
  * @{
  */
...
/**
  ...
  */
#if defined(STM32F446xx)    
/** @defgroup RCC_SAI_Clock_Source RCC_SAI_Clock_Source
  * @{
  */
...
/** @defgroup RCC_SAI_Instance RCC_SAI_Instance
  * @{
  */
...
/** @defgroup RCC_SAI_BlockA_Clock_Source RCC_SAI_BlockA_Clock_Source
  * @{
  */
...
/** @defgroup RCC_SAI_BlockB_Clock_Source RCC_SAI_BlockB_Clock_Source
  * @{
  */
...
/** @defgroup RCC_TIM_PRescaler_Selection RCC_TIM_PRescaler_Selection
  * @{
  */
...
/** @defgroup RCC_DSI_Clock_Source_Selection RCC_DSI_Clock_Source_Selection
  * @{
  */
...
/** @defgroup RCC_SDIO_Clock_Source_Selection RCC_SDIO_Clock_Source_Selection
  * @{
  */
...
/** @defgroup RCC_48MHZ_Clock_Source_Selection RCC_48MHZ_Clock_Source_Selection
  * @{
  */
#if  defined(STM32F446xx) || defined(STM32F469_479xx)
...
#if defined(STM32F446xx) 
/** @defgroup RCC_SPDIFRX_Clock_Source_Selection RCC_SPDIFRX_Clock_Source_Selection
  * @{
  */
...
/** @defgroup RCC_CEC_Clock_Source_Selection RCC_CEC_Clock_Source_Selection
  * @{
  */
...
/** @defgroup RCC_AHB1_ClockGating RCC_AHB1_ClockGating
  * @{
  */ 
...
/** @defgroup RCC_FMPI2C1_Clock_Source RCC_FMPI2C1_Clock_Source
  * @{
  */
...
#if defined(STM32F412xG) || defined(STM32F413_423xx)
/** @defgroup RCC_DFSDM_Clock_Source RCC_DFSDM_Clock_Source
 * @{
 */
...
/** @defgroup RCC_AHB1_Peripherals RCC_AHB1_Peripherals
  * @{
  */ 
...
/** @defgroup RCC_AHB3_Peripherals RCC_AHB3_Peripherals
  * @{
  */ 
...
/** @defgroup RCC_MCO1_Clock_Source_Prescaler RCC_MCO1_Clock_Source_Prescaler
  * @{
  */
...
/** @defgroup RCC_MCO2_Clock_Source_Prescaler RCC_MCO2_Clock_Source_Prescaler
  * @{
  */
